...
class EventList:
    ...
    Instance Attributes:
        - first: the first event to happen in the game
        - last: the latest event to happen this game
    ...
    def get_id_log(self) -> list[int]:
        ...
        result = []
        event = self.first
        while event != self.last:
            result.append(event.id_num)
            event = event.next
        result.append(self.last.id_num)
        return result
